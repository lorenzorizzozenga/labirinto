      ...
      <div className="px-4 md:px-8 py-8 md:py-10 max-w-2xl">
        <FadeIn>
          <div className="flex flex-col gap-6 text-sm leading-7 text-zinc-700">
            <p>
              Labirinto è uno studio creativo. Lavoriamo con brand, istituzioni
              e persone che vogliono comunicare con chiarezza in un mondo
              complesso.
            </p>
            <p>
              Il nome viene dall&apos;idea che ogni progetto è un percorso da
              costruire insieme — non una strada dritta, ma un processo fatto
              di scelte, deviazioni e scoperte. Quello che emerge alla fine è
              sempre più interessante di ciò che si immaginava
              all&apos;inizio.
            </p>
            <p>
